...
dict_functions['Sleep_Time_Course'] = {
        ...
        'type_func' : 'Sleep',
        'accepted_type' : ['EEG Full Power Spectrum','EEG Binned Frequencies']}
...
dict_functions['LDA'] = {
        ...
        'accepted_type' :['TSE','AM-Microsystems','EEG Full Power Spectrum','EEG Binned Frequencies']}
