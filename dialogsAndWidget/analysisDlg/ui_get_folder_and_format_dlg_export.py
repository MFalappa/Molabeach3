...
class Ui_Dialog_export(object):
    def setupUi(self, Dialog_export):
        ...
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(Dialog_export)
        ...
        self.label_delimiter = QtWidgets.QLabel(Dialog_export)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.comboBox = QtWidgets.QComboBox(Dialog_export)
        ...
        self.comboBox_2 = QtWidgets.QComboBox(Dialog_export)
        ...
        self.lineEdit = QtWidgets.QLineEdit(Dialog_export)
        self.lineEdit.setObjectName(_fromUtf8("lineEdit"))
        self.horizontalLayout_4.addWidget(self.lineEdit)
        self.pushButton_browse = QtWidgets.QPushButton(Dialog_export)
        ...
        self.pushButton_Cancel = QtWidgets.QPushButton(Dialog_export)
        self.pushButton_Cancel.setObjectName(_fromUtf8("pushButton_Cancel"))
        self.horizontalLayout_5.addWidget(self.pushButton_Cancel)
        self.pushButton_ok = QtWidgets.QPushButton(Dialog_export)
